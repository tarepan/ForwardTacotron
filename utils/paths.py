...
class Paths:
    ...
    def __init__(self, data_path, voc_id, tts_id):
        ...
        self.forward_latest_gen_opti = self.forward_checkpoints/'latest_gen_optim.pyt'
        self.forward_latest_disc_opti = self.forward_checkpoints/'latest_disc_optim.pyt'
